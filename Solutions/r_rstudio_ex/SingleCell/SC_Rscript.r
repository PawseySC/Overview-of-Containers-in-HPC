...
png(filename="files/filtered_pc_plots.png")
...
png(filename="files/pca_var_plot.png")
plotPCAVariance(pca_set, n = 50)
dev.off()
png(filename="files/pca_plot.png")
...
png(filename="files/stability_dendro_plot.png")
plotStabilityDendro(clustered_set)
dev.off()
png(filename="files/stability_plot.png")
plotStability(clustered_set)
dev.off()
png(filename="files/dendogram.png")
...
png(filename="files/tsne_plot.png")
tsne_plot
dev.off()
png(filename="files/pca_plot.png")
pca_plot
dev.off()
png(filename="files/mds_plot.png")
mds_plot
dev.off()
...
png(filename="files/cluster1_volcano.png")
cluster1_volcano
dev.off()
png(filename="files/cluster2_volcano.png")
cluster2_volcano
dev.off()
png(filename="files/cluster3_volcano.png")
cluster3_volcano
dev.off()
...
png(filename="files/volcano_deseq.png")
